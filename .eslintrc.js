module.exports = {
    ...
    "rules": {
        ...
        // "no-empty-label": 2, 此规则已在ESLint v2.0中删除，并替换为no-labels规则。
        "no-eq-null": 0,
        "no-eval": 2,
        "no-ex-assign": 2,
        "no-extend-native": 2,
        ...
        "semi-spacing": 0,
        "sort-vars": 0,
        // "space-after-keywords": [2, "always"], 此规则在ESLint v2.0中已删除，并由keyword-spacing规则取代。
        "space-before-blocks": [2, "always"],
        "space-before-function-paren": [2, "always"],
        "space-in-parens": [2, "never"],
        "space-infix-ops": 2,
        // "space-return-throw-case": 2, 此规则在ESLint v2.0中已删除，并由keyword-spacing规则取代。
        "space-unary-ops": [2, {
            "words": true,
            "nonwords": false
        }],
